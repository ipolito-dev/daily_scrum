...
void main() {
  ...
  test('Should returned one DatasourceError when statusCode different 200...',
      () async {
    when(() => restClient.get(any(),
        queryParameters: any(named: "queryParameters"))).thenAnswer(
      (_) async => Response(
  ...
  test('Should returned one Error in updateDaily when exist error internal of Dio...',
      () async {
    when(() => restClient.put(any(),
